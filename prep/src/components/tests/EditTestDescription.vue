<template>
    <div id="edit-test-description" style="background-color:white; padding: 10px 50px 10px 50px; margin-top:10px" >
        <div id="mainScreen" class="row">
            <h3>Edit Test</h3>
            <form @submit.prevent="updateTest" class="col s12">
                <div class="row">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <p>Department</p>
                        <input type="text" v-model.trim="department" required>
                    </div>
                </div>
                <ul class="collapsible">
                    ...
                    you can leave this blank for now and edit the information later.<br><br>
                    Images can also be uploaded by clicking on the image icon. Images should be placed in-between blocks of text so that they correctly display in the app.<br><br>
                    When entering web links, please ensure they are copied directly from the browser bar. Eg starting with https rather than www. </span>
                    </div>
                    </li>
                </ul>
                ...
                <div class="navButtons">
                    ...
                    <router-link to="/view-tests" class="btn grey">Cancel</router-link>
                </div>
            </form>
        </div>
    </div>
