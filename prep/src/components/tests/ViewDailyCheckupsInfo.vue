...
<script>
    ...
    export default{
        ...
        beforeRouteEnter (to, from, next) {
            db.collection('tests').doc(to.params.test_id).collection('dailyCheckups').where('title', '==', to.params.daily_id).get()
            .then(querySnapshot => {
        ...
        methods: {
            fetchData (){
                db.collection('tests').doc(this.$route.params.test_id).collection('dailyCheckups').where('title', '==', this.$route.params.daily_id).get()
                .then(querySnapshot => {
                    querySnapshot.forEach(doc => {
                        this.code=doc.id
