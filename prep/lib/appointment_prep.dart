...
class AppointmentPrep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: new ListView(
        children: <Widget>[
            CategoryCard("Allowed foods", 139, Colors.green[200], Colors.yellow[200],'assets/images/vegpacket.png'),
...
class CategoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) { 
    ...
    var image=new Image(image: assetimage,height: 48.0, width: 24.0, fit: BoxFit.fitWidth);
    return Card(
      elevation: 3.0,
      child: InkWell(
        onTap: () {
