...
void main() {
  ...
  testWidgets(
      'Calendar class has test name, location, staff member name, date, time and appintment code',
        ...
        await tester.pumpWidget(CalendarCard(
            "hjhfuz3ey", "St. Thomas Hospiutal", DateTime(2019, 3, 25, 10, 0),
            "VyyiBYwp0xX4nJyvX9oN", "Eliana Reyes",
...
//            calendarCard.dateFormatter(DateTime(2019, 3, 25, 10, 0)));
//        final time = find.text(
//            calendarCard.timeFormatter(DateTime(2019, 3, 25, 10, 0)));
